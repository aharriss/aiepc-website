  ...
  return (
    <Card className="border-[#A9A9A9] sticky top-10">
      <CardContent className="p-6">
        ...
        {step === 1 && (
          <div>
            <h2 className="text-2xl font-bold text-[#00308f] mb-4">Apply to Start Your Local Division</h2>
            <p className="text-gray-700 text-sm mb-6">
              Applicants for starting local divisions must be members. If you are not a member yet, you'll be directed to the membership sign-up page after completing this form, with your details pre-filled.
            </p>
            <form className="space-y-4" onSubmit={(e) => { e.preventDefault(); handleNext(); }}>
              ...
              <Input placeholder="Email" className="border-[#A9A9A9]" value={form.email} onChange={(e) => setForm({ ...form, email: e.target.value })} />
              <p className="text-xs text-gray-600 italic">Your name won't be disclosed until safe</p>
              <Input placeholder="Workplace / Industry" className="border-[#A9A9A9]" value={form.workplace} onChange={(e) => setForm({ ...form, workplace: e.target.value })} />
              ...
              <Textarea placeholder="Why do you want to start a local division?" className="border-[#A9A9A9]" value={form.why} onChange={(e) => setForm({ ...form, why: e.target.value })} />
              ...
              <div className="mt-4 p-3 bg-blue-50 border border-blue-200 rounded-lg">
                <p className="text-xs text-gray-600 leading-relaxed">
                  Note that at least 30% of employees in a proposed bargaining unit must sign authorization cards for the National Labor Relations Board (NLRB) to hold an election. We will gather names privately until approximately 30% of your company has registered. Once approximately 30% of your company has registered, you will receive an email to let you know that you and your company are now ready to begin the process to organize your union, which we help facilitate. <a href="/union-process" className="text-[#00308f] underline hover:text-[#5D8AA8]">Click here to learn more about that process.</a>
                </p>
              </div>
            </form>
          </div>
        ...
        {step === 2 && (
          <div>
            ...
            <p className="text-gray-700 text-sm mb-6">
              To start a Local Division, you must be a member of AI Union. Continue to the membership sign-up page. Your application details will be pre-filled.
            </p>
            <div className="flex items-center justify-between gap-3">
        ...
        {step === 3 && (
          <div>
            ...
            <div className="bg-[#B0B7BC] bg-opacity-20 p-4 rounded-lg mb-4">
              ...
              <p><strong>Workplace / Industry:</strong> {form.workplace || "—"}</p>
