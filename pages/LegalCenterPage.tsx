...
// AIEPC Logo using provided image
// AIEPC Logo using provided image - clickable to return home
function AIEPCLogo({ className = "h-8 w-auto" }: { className?: string }) {
  return (
    <a href="/">
      <img
        ...
        <div className="mx-auto max-w-6xl px-4 py-12">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            <div className="md:col-span-2">
              <AIEPCLogo className="h-10 w-auto mb-4" />
